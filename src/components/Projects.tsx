      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-12 max-w-6xl mx-auto">
          {projects.map((project, index) => (
            <Card 
              key={index}
              className="bg-background border-border hover:shadow-card transition-all duration-500 animate-fade-up overflow-hidden group"
            >
                  ...
                  <div className="mb-8">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tech.map((tech, techIndex) => (
                        <span 
                          key={techIndex}
                          className="px-3 py-1 bg-glass-bg border border-glass-border text-foreground text-sm rounded-full"
                        >
                          {tech}
                        </span>
                      ))}
